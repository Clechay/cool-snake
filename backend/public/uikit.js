...
(function(global, factory) {
  ...
  function children(element, selector) {
    ...
    return selector
      ? children.filter(function(element) {
  ...
  function isInView(element, offsetTop, offsetLeft) {
    ...
    for (var i = 0; i < parents.length - 1; i++) {
      ...
      if (
        ...
        !pointInRect({ x: client.left, y: client.top }, vp)
      ) {
        return false;
      }
    }
    ...
    events: [
      {
        ...
        handler: function(e) {
          e.preventDefault();
          this.show(
            children(this.$el).filter(function(el) {
    ...
    events: [
...

      {
        ...
        handler: function(_, item) {
          ...
          if (
            type === 'image' ||
            source.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i)
          ) {
    ...
    methods: {
      ...
      move: function(e) {
        ...
        target =
          ...
          children(sortable.$el).filter(function(element) {
  ...
  function appendDrag(container, element) {
    var clone = append(
      container,
      element.outerHTML.replace(/(^<)li|li(\/>$)/g, '$1div$2')
    );
